...
ADVANCED, HELPER,APPR,USER, APPR,
SYSOP, APPR, APPR,APPR,HELPER,
APPR,APPR,MAGHETTO,MAGHETTO,ARCH,
ARCH,ARCH,ARCH,NEW,PROMOTER,
PROMOTER,PROMOTER,MAGHETTO,ADVANCED,ADVANCED,
WIZ,WIZ,MAGHETTO, USER,WIZ,
WIZ,WIZ,APPR,GOD, GOD,
MAGHETTO,NEW,ADVANCED,PROMOTER,PROMOTER,
WIZ,NEW,USER,
ARCH,
/*
ARCH,
...
*/
ARCH,ADVANCED,APPR,NEW,NEW,
USER,USER,NEW,ADVANCED, SYSOP,
PROMOTER, APPR,USER,USER,HELPER,
USER,APPR,GOD, PROMOTER,APPR
};
